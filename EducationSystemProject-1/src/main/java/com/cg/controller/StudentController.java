...
public class StudentController {
	...
	public ResponseEntity<Student> updateStudent(@PathVariable("studentid") Integer studentId, @RequestBody Student s)
			throws StudentException, EntityNotFoundException, StudentNotFoundException,
			RegistrationRequestNotApprovedException {
	...
	public ResponseEntity<String> deleteStudentById(@PathVariable("studentid") Integer sid) {
